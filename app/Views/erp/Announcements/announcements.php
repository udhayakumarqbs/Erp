<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.announcementsadd') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> New Announcement </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.announcementsresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo url_to("erp.Announcements.announcementexport") . '?export=excel&'; ?>" href="<?php echo base_url() . 'erp/Announcements/announcements-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo url_to("erp.Announcements.announcementexport") . '?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/Announcements/announcements-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo url_to("erp.Announcements.announcementexport") . '?export=csv&'; ?>" href="<?php echo base_url() . 'erp/Announcements/announcements-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
