<div class="alldiv flex widget_title">
    <h3 class="">Update Announcements</h3>
...
<div class="alldiv">
    <?php
    echo form_open(url_to('erp.announcementsupdate', $id), array(
        "class" => "flex",
    ...
    <div class="form-width-3  form-control">
        <div class="form-group field-required">
            ...
            <?php echo  form_input('name',$value, 'id="name_id" class = "form_control"'); ?>
...
<script>
    ...
    $(document).ready(function(){
        $('#announcement_update_form').submit(function (event){
