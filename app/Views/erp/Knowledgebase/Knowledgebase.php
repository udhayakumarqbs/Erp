<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.Knowledgebasegroupview'); ?>" class="btn bg-primary"><i
                class="fa-solid fa-layer-group"></i> Groups</a>
    </div>
    <div class="title_right">
        <a href="<?php echo url_to('erp.Knowledgebaseadd'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> New
            Article</a>
    </div>
</div>
<style>
...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.Knowledgebaseajaxarticle') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=excel&'; ?>"
                                href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=excel&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>"
                                    alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=pdf&'; ?>"
                                href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=pdf&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>"
                                    alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=csv&'; ?>"
                                href="<?php echo url_to('erp.knowledgebase.article.export') . '?export=csv&'; ?>"
