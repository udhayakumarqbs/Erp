...
<div class="alldiv">
    <?php
        echo form_open(url_to('erp.procurement.createorder_rfq', $Req_id, $req_id),array(
    ...
    ?>
        <div class="form-width-3">
            <div class="form-group field-ajax " data-ajax-url="<?php echo base_url().'erp/procurement/ajax_order_code_unique?'; ?>" >
                ...
                <input type="text" name="order_code" class="form_control field-check" />
        ...
        <div class="form-width-1">
            ...
            <input type="hidden" class="d-none" name="rfq_id" value="<?= $Req_id ?? "";?>">
