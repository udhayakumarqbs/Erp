...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo base_url().'erp/procurement/ajax_rfq_response?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url().'erp/procurement/rfq_export?export=excel&';?>" href="<?php echo base_url().'erp/procurement/rfq_export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/procurement/rfq_export?export=pdf&';?>" href="<?php echo base_url().'erp/procurement/rfq_export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/procurement/rfq_export?export=csv&';?>" href="<?php echo base_url().'erp/procurement/rfq_export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $rfq_datatable_config; ?>');
