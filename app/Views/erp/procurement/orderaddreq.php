<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.procurement.orders') ;?>" class="btn bg-success" ><i class="fa fa-reply" ></i> Back </a>
    </div>
</div>

<div class="alldiv">
    <?php
        echo form_open(url_to('erp.procurement.createorder_req',$req_id),array(
            "id"=>"createorder_req_form",
            "class"=>"flex"
        ));
    ?>
        <div class="form-width-3">
            <div class="form-group field-ajax " data-ajax-url="<?php echo base_url().'erp/procurement/ajax_order_code_unique?'; ?>" >
                <label class="form-label">Order Code</label>
                <input type="text" name="order_code" class="form_control field-check" value="<?= "ORD".date("y")."/".str_pad(intval($get_order_count->count) + 1,4,0,STR_PAD_LEFT) ?>" />
        ...
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="date" name="delivery_date" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        ...
        <div class="form-width-2">
            <div class="form-group">
                <div>
                    <label class="form-check-label"><input id="internal_transport" type="checkbox" name="internal_transport" value="1" /> Use Company's Transport</label>
                </div>
                <p class="error-text" ></p>
            </div>
        </div>
            ...
            <div class="form-group field-required field-no-validate" >
                ...
                <div class="ajaxselectBox transportajaxselectbox poR" data-ajax-url="<?php echo base_url().'erp/procurement/ajaxfetchtransport'; ?>" >
                    <div class="ajaxselectBoxBtn flex"> 
                        <div class="textFlow" data-default="Select Transport">Select Transport</div>
                        <button class="close" type="button" ><i class="fa fa-close" ></i></button>
                        <button class="drops" type="button" ><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" class="ajaxselectBox_Value field-check" name="transport_id" value="" >
                    </div>
        ...
        <div class="form-width-2 internal-transport-field" >
            <div class="form-group field-number field-no-validate">
                ...
                <input type="text" name="transport_unit" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2 internal-transport-field" >
            <div class="form-group field-money field-no-validate">
                ...
                <input type="text" name="transport_charge" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
        ...
        <div class="form-width-1">
            <div class="form-group">
                ...
                <textarea rows="3" name="notes" class="form_control field-check" ></textarea>
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-1">
        ...
        <div class="form-width-1">
            <table class="table" >
                ...
                <tbody id="order_items_holder" >
                    <?php
                        $index=1;
                        foreach ($requisition_items as $row) {
                    ?>
                    <tr>
                        <td><?php echo $index; ?></td>
                        <td><?php echo $row['product']; ?></td>
                        <td class="db-qty"><?php echo $row['qty'] ;?></td>
                        <td>
                            <div class="form-group field-required" >
                                <div class="ajaxselectBox poR" data-ajax-url="<?php echo base_url().'erp/procurement/ajaxfetchpricelist'; ?>" >
                                    <div class="ajaxselectBoxBtn flex"> 
                                        <div class="textFlow" data-default="Price List">Price List</div>
                                        <button class="close" type="button" ><i class="fa fa-close" ></i></button>
                                        <button class="drops" type="button" ><i class="fa fa-caret-down"></i></button>
                                        <input type="hidden" class="ajaxselectBox_Value field-check" name="price_list_<?php echo $row['invent_req_id']; ?>" value="" >
                                    </div>
                                    <div class="ajaxselectBox_Container alldiv">
                                        <input type="text" class="ajaxselectBox_Search form_control" />
                                        <ul role="listbox" >
                ...
                <tfoot>
                    <tr>
                        ...
                        <td ><b id="order_items_total" >0.00</b></td>
                    </tr>
                </tfoot>
            </table>
        </div>
        <div class="form-width-1" >
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="button" id="createorder_req_btn" >Save</button>
            </div>
        </div>
    <?php
        echo form_close();
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        function get_supplier_location(supplier_id){
                            ...
                            let html=`<div class="form-group field-required">
                                        ...
                                        <div class="selectBox supplierlocationselectbox poR" >
                                            <div class="selectBoxBtn flex"> 
                                                ...
                                                <button class="close" type="button" ><i class="fa fa-close"></i></button>
                                                <button class="drops" type="button" ><i class="fa fa-caret-down"></i></button>
                                                <input type="hidden" class="selectBox_Value field-check" name="supplier_location" value="" >
                                            </div>
                                            <ul role="listbox" class="selectBox_Container alldiv">`;
        ...
        let form=document.getElementById("createorder_req_form");
        let validator=new FormValidate(form);

        let lock=false;
        document.getElementById("createorder_req_btn").onclick=function(evt){
            if(!lock){
                lock=true;
                validator.validate(
                (params)=>{
