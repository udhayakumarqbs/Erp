...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo base_url().'erp/procurement/ajax_order_response?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="order_filter_1" >
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo url_to('erp.procurement.order_export').'?export=excel&';?>" href="<?php echo base_url().'erp/procurement/order_export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo url_to('erp.procurement.order_export').'?export=pdf&';?>" href="<?php echo base_url().'erp/procurement/order_export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo url_to('erp.procurement.order_export').'?export=csv&';?>" href="<?php echo base_url().'erp/procurement/order_export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $order_datatable_config; ?>');
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("order_filter_1");
