...
<div class="alldiv">
    <?php
        echo form_open(base_url().'erp/procurement/requisitionedit/'.$req_id,array(
            "id"=>"requisition_edit_form",
            "class"=>"flex"
        ));
    ?>
        <div class="form-width-3">
            <div class="form-group field-ajax " data-ajax-url="<?php echo base_url().'erp/procurement/ajax_requisition_code_unique?id='.$req_id.'&'; ?>" >
                <label class="form-label">Requisition Code</label>
                <input type="text" name="req_code" value="<?php echo $requisition->req_code; ?>" class="form_control field-check" />
        ...
        <div class="form-group field-required" >
            ...
            <div class="ajaxselectBox req_ajax_select_box poR" data-ajax-url="<?php echo url_to('erp.crm.ajaxFetchUsers'); ?>" >
                <div class="ajaxselectBoxBtn flex"> 
                    <div class="textFlow" data-default="assign to"><?php echo $requisition->name; ?></div>
                    <button class="close" type="button" ><i class="fa fa-close" ></i></button>
                    <button class="drops" type="button" ><i class="fa fa-caret-down"></i></button>
                    <input type="hidden" class="ajaxselectBox_Value field-check" name="assigned_to" value="<?php echo $requisition->assigned_to; ?>" >
                </div>
        ...
        <div class="form-group field-required">
            ...
            <div class="selectBox req_select_box poR" >
                <div class="selectBoxBtn flex"> 
                    ...
                    <button class="close" type="button" ><i class="fa fa-close"></i></button>
                    <button class="drops" type="button" ><i class="fa fa-caret-down"></i></button>
                    <input type="hidden" class="selectBox_Value field-check" name="priority" value="<?php echo $requisition->priority; ?>" >
                </div>
        ...
        <div class="form-width-1">
            <div class="form-group field-required ">
                ...
                <textarea rows="3" name="description" class="form_control field-check" ><?php echo $requisition->description; ?></textarea>
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-1">
            ...
            <table class="table" >
                ...
                <tbody id="requisition_items_holder" >
                    <?php
                        ...
                        <tr>
                            <td>
                                <input type="hidden" name="product_type_<?php echo $req_item_counter; ?>" value="<?php echo $item['related_to']; ?>" />
                                <span><?php echo $req_item_counter ; ?></span>
                            </td>
                            <td>
                                <input type="hidden" name="product_id_<?php echo $req_item_counter; ?>" value="<?php echo $item['related_id']; ?>" />
                                <span><?php echo $item['product'] ; ?></span>
                            </td>
                            <td>
                                <input type="hidden" name="product_qty_<?php echo $req_item_counter; ?>" value="<?php echo $item['qty']; ?>" />
        ...
        <div class="form-width-1" >
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="button" id="requisition_edit_btn" >Update</button>
            </div>
        </div>
    <?php
        echo form_close();
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let form=document.getElementById("requisition_edit_form");
        let validator=new FormValidate(form);

        let lock=false;
        document.getElementById("requisition_edit_btn").onclick=function(evt){
            if(!lock){
                lock=true;
                validator.validate(
                (params)=>{
        ...
        */
        ...
        let req_product_counter=parseInt("<?php echo $req_item_counter; ?>");
