...
<div class="alldiv">
    <?php echo form_open(url_to('erp.expensesadd'), array(
        // "class" => "flex",
        "id" => "expense_add",
            ...
            <div class="form-width-3 form-control">
                <div class="form-group field-required">
                    ...
                    <div>
                        ...
                        <?php echo form_textarea('ExpensesNotes', '', 'class ="form-control-text-area"'); ?>
                        <p></p>
                    </div>
                        ...
                        <div class="form-group field-required d-flex align-items-center">
                            <div class="ajaxselectBox poR">
                                <div class="ajaxselectBoxBtn flex">
                                    <div class="textFlow" id="show_select_option" data-default="select expense_id">select related</div>
                    ...
                    <div class="btn-group">
                        ...
                        <input type="date" name="expense_date" value="" id="expense-date" class="form-control">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <div class="d-flex">
                            <input type="number" class="form-control-btn mb-1" id="amount_id" name="amount">
                            <label class="rupees">
                    ...
                    <div class="form-group field-required">
                        ...
                        <div class="selectBox poR">
                            <div class="selectBoxBtn flex" id="ajax-form-customer">
                                <div class="textFlow" data-default="customer">--Select--</div>
                                <button class="close" type="button"><i class="fa fa-close"></i></button>
                                <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                                <input type="hidden" class="selectBox_Value field-check" name="dropdown_customer_type" value="" id="customer_type">
                            </div>
                            <ul role="listbox" class="selectBox_Container related alldiv customer_cont_dropdown">
                                <?php
                                foreach ($customers as $value) {
                                ?>
                                    <li role="option" data-value="<?php echo $value["cust_id"]; ?>" onClick="project_show(event)"><?php echo $value["company"]; ?></li>
                                <?php
                                }
                                ?>
                            </ul>
            ...
            <div class="form-width-3 form-control">
                        ...
                        <div class="form-group field-required">
                            <div class="selectBox poR">
                                <div class="selectBoxBtn flex" id="ajax-form-tax-1">
                                    <div class="textFlow" data-default="select Tax" id="tax-1-text">--Select--</div>
                                    <button class="close" type="button"><i class="fa fa-close"></i></button>
                                    <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                                    <input type="hidden" class="selectBox_Value field-check" name="tax1" value="" id="tax_1">
                                </div>
                        ...
                        <div class="form-group field-required">
                            <div class="selectBox poR">
                                <div class="selectBoxBtn flex" id="ajax-form-tax-2">
                                    <div class="textFlow" data-default="select Tax" id="tax-2-text">--Select--</div>
                                    <button class="close" type="button"><i class="fa fa-close"></i></button>
                                    <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                                    <input type="hidden" class="selectBox_Value field-check" name="tax2" value="" id="tax_2">
                                </div>
                                <ul role="listbox" class="selectBox_Container alldiv">
                                    <?php
                                    foreach ($tax_data as $t) {
                ...
                <div>
                    ...
                    <div class="btn-group mt-3">
                        <div class>
                            ...
                            <div class="form-group field-required">
                                <div class="selectBox poR">
                                    <div class="selectBoxBtn flex">
                                        <div class="textFlow" data-default="select Pay Mode" id="payment-text">--Select--</div>
                                        <button class="close" type="button"><i class="fa fa-close"></i></button>
                                        <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                                        <input type="hidden" class="selectBox_Value field-check" name="payment" value="" id="payment_mode">
                                    </div>
                                    <ul role="listbox" class="selectBox_Container alldiv">
                                        <?php
                    ...
                    <div class="btn-group mt-3">
                        ...
                        <input type="text" name="refrence" class="form_control" id="refrence_id">
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.selectBox_Container.related').on('click', 'li', function() {
            ...
            $("#project_cont_id").toggleClass("hide");
            $("#check_box_id").toggleClass("hide");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response && response.length > 0) {
                        ...
                        $('#show_select_project').attr('disabled', false);
    ...
    $(document).ready(function() {
        ...
        $("#expense_add").submit(function(event) {
            event.preventDefault();
            var name = $("#name_id").val();
            var date = $("#expense-date").val();
            var amount = $("#amount_id").val();
            // var currency = $("#curreny_type").val();
            if (!name) {
