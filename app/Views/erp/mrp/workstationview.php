...
<div class="alldiv flex widget_title">
    ...
    <a href="<?php echo url_to('erp.mrp.workstationadd.view'); ?>" class="btn bg-success"><i class="fa-solid fa-plus fa-lg"></i> Add
    </a>
    </div>
</div>
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.mrp.workstationdatatable') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
