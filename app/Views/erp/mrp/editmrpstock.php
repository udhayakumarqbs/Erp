...
<?//= var_dump($mrp_scheduling) ?>
<div class="alldiv">
    <form action="<?= url_to('erp.mrp.editmrpstock', $planning_id,$mrp_scheduling->mrp_scheduling_id) ?>" method="POST" class="flex" id="stock_add_form">
        <div class="form-width-2">
            <div class="form-group field-ajax" data-ajax-url="<?= url_to('erp.ajax.managestock') . '?' ?>">
                <label class="form-label">SKU</label>
                <input type="text" name="disabled" class="form_control field-check" value="<?= $mrp_scheduling->sku ?>"  disabled/>
                <input type="hidden" name="sku" value="<?= $mrp_scheduling->sku ?>">
            ...
            <div class="form-group field-required">
                ...
                <div class="selectBox poR">
                    <div class="selectBoxBtn flex">
                        ...
                        <input type="hidden" class="selectBox_Value field-check" name="warehouse_id" value="<?= $mrp_scheduling->warehouse_id ?>">
                    </div>
            ...
            <div class="form-group field-required">
                ...
                <div class="ajaxselectBox poR" data-ajax-url="<?= url_to('erp.procurement.ajaxfetchpricelist'); ?>">
                    <div class="ajaxselectBoxBtn flex">
                        ...
                        <button class="close" type="button"><i class="fa fa-close"></i></button>
                        <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" class="ajaxselectBox_Value field-check" name="price_id" value="<?= $mrp_scheduling->price_id ?>">
                    </div>
                    <div class="ajaxselectBox_Container alldiv">
                        <input type="text" class="ajaxselectBox_Search form_control" />
                        <ul role="listbox">
        ...
        <div class="form-width-2">
            <div class="form-group ">
                ...
                <input type="text" name="stock" class="form_control field-check" value="<?= $mrp_scheduling->stock ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group ">
                ...
                <input type="text" name="bin_name" class="form_control field-check" value="<?= $mrp_scheduling->bin_name ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="date" name="mfg_date" class="form_control field-check" value="<?= $mrp_scheduling->mfg_date ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group ">
                ...
                <input type="text" name="batch_no" class="form_control field-check" value="<?= $mrp_scheduling->batch_no ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group ">
                ...
                <input type="text" name="lot_no" class="form_control field-check" value="<?= $mrp_scheduling->lot_no ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1">
            <div class="form-group textRight">
                ...
                <button class="btn bg-primary" type="button" id="stock_add_submit">Update</button>
            </div>
        </div>
    </form>
</div>
