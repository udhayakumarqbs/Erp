...
<div class="alldiv">
    <form action="<?= url_to('erp.mrp.operation.edit', $operation_data['id']) ?>" method="POST" class="flex"
        id="stock_add_form">
        <div class="form-width-2">
            <div class="form-group field-required">
                <label class="form-label">Operation Name</label>
                <input type="text" class="form_control" name="operation_name"
                    value="<?= $operation_data['operation_name'] ?? ""; ?>">
            ...
            <div class="form-group field-required">
                ...
                <div class="selectBox poR">
                    <div class="selectBoxBtn flex">
                        <div class="textFlow" data-default="select priority"><?= $operation_data['workstation_name'] ?>
                        </div>
                        <button class="close" type="button"><i class="fa fa-close"></i></button>
                        <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" class="selectBox_Value field-check" name="workstation_id"
                            value="<?= $operation_data['workstation_id'] ?>">
                    </div>
        ...
        <div class="form-width-1">
            <div class="form-group field-required ">
                ...
                <textarea name="description" class="form_control"><?= $operation_data['description']; ?></textarea>
                <p class="error-text"></p>
            </div>
        </div>
        ...
        <div class="form-width-1">
            <input type="checkbox" class="dt-checkbox-child" name="is_corrective_operation" value="1"
                <?= !empty($operation_data['is_corrective_operation']) ? "checked" : ""; ?>>
