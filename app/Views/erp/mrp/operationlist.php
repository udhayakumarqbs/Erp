<div class="alldiv flex widget_title">
    <h3>BOM Operations</h3>
    <div class="title_right">
        <a href="<?php echo url_to('erp.mrp.operation.add',1); ?>" class="btn bg-success"><i
                class="fa fa-plus"></i> Add </a>
    </div>
</div>
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.mrp.operation.datatable') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
                <h4>Search</h4>
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php //echo base_url() . 'erp/service/service-export?export=excel&'; ?>"
                                href="<?php //echo base_url() . 'erp/service/service-export?export=excel&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>"
                                    alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php //echo base_url() . 'erp/service/service-export?export=pdf&'; ?>"
                                href="<?php //echo base_url() . 'erp/service/service-export?export=pdf&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>"
                                    alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php //echo base_url() . 'erp/service/service-export?export=csv&'; ?>"
                                href="<?php //echo base_url() . 'erp/service/service-export?export=csv&'; ?>"
