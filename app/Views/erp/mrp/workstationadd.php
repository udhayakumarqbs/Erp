...
<div class="alldiv">
    <form action="<?= url_to('erp.mrp.workstationadd.view') ?>" method="POST" class="flex" id="workstation_add_form">
        <div class="form-width-2">
            <div class="form-group field-required">
                <label class="form-label">Workstation Name</label>
                <input type="text" class="form_control field-check" name="name" value="">
            ...
            <div class="form-group field-required">
                ...
                <div class="ajaxselectBox poR" data-ajax-url="<?= url_to('erp.mrp.ajax.workstation.types.list'); ?>">
                    <div class="ajaxselectBoxBtn flex">
                        <div class="textFlow" data-default="select product">select workstation Type</div>
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="time" name="work_start_date" id="work_start_date" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="time" name="work_end_date" id="work_end_date" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <hr>
        ...
        <div class="form-width-1">
            <div class="form-group">
                ...
                <textarea type="date" name="description" id="description" class="form-control-text-area"></textarea>
                <p class="error-text"></p>
            </div>
        </div>
        <? //= var_dump($status) ?>
        <div class="form-width-1 mt-5">
            <div class="form-group textRight">
                ...
                <button class="btn bg-primary" type="button" id="workstation_add_submit">Save</button>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    let form = document.getElementById("workstation_add_form");
    let validator = new FormValidate(form);
    let lock = false;
    document.getElementById("workstation_add_submit").onclick = function (evt) {
        if (!lock) {
            lock = true;
            validator.validate(
                (params) => {
