<div class="alldiv flex widget_title">
    <h3>Bill Of Material Overview</h3>
    <!-- <div class="title_right">
        <a href="<?php //echo url_to('erp.mrp.productplanningadding'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
    </div> -->
</div>
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.mrp.overall.bom.datatable') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
                    ...
                    <div class="selectBox poR" id="planning_filter_1">
                        ...
                        <ul role="listbox" class="selectBox_Container alldiv">
                            ...
                            foreach ($status as $key => $v) {
                                ?>
                                <li role="option" data-value="<?php echo $key; ?>"><?php echo $v; ?></li>
                                <?php
                            }
                            ?>
                        </ul>
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=excel&'; ?>"
                                href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=excel&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>"
                                    alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=pdf&'; ?>"
                                href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=pdf&'; ?>"
                                target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>"
                                    alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=csv&'; ?>"
                                href="<?php echo base_url() . 'erp/mrp/overall-bom-export?export=csv&'; ?>"
        ...
        <div class="tableFooter flex">
            ...
            <div class="tableFooterRight flex">
                <div class="pagination"><span class="dt-page-start">1</span> - <span class="dt-page-end">5</span> of
                    <span class="dt-total-rows">100<span></div>
