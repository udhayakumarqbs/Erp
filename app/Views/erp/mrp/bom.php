            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="form-group field-required">
                        <div class="selectBox poR" id="bom_filter_1">
                            ...
                            <ul role="listbox" class="selectBox_Container alldiv">
                                <?php
                                foreach ($bom_status as $key => $status) {
                                ?>
...
<script>
    ...
    let config = JSON.parse('<?php echo $bom_dtconfig; ?>');
    ...
    if (config['filters'] !== null && config['filters'] !== undefined) {
        let filter_1 = document.getElementById("bom_filter_1");
...
<script>
    ...
    if (session()->getFlashdata("op_success")) { ?>
        ...
        alerts.invoke_alert("<?php session()->getFlashdata('op_success'); ?>", "success");
    <?php
