    ...
    <div class="form-width-3  form-control">
        <div class="form-group field-required">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <div class="d-flex">
                    <input type="number" class="form-control-btn mb-1" id="achievement_id" name="contractType">
                    <label class="rupees">
            ...
            <div class="d-flex mb-1">
                ...
                <div class="date-end btn-group">
                    ...
                    <input type="date" name="end_date" value="" id="end-date" class="form-control-enddate">
            ...
            <div class="tw-flex tw-justify-between tw-items-center mb-4">
                <div>
                    ...
                    <div class="checkbox checkbox-primary checkbox-inline">
                        <input type="checkbox" name="hide_from_customer" id="hide">
