<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="#" id="proptype_modal_invoker1" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.inventory.ajaxpropertytyperesponse').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/propertytype-export?export=excel&';?>" href="<?php echo base_url().'erp/inventory/propertytype_export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/propertytype-export?export=pdf&';?>" href="<?php echo base_url().'erp/inventory/propertytype_export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/propertytype-export?export=csv&';?>" href="<?php echo base_url().'erp/inventory/propertytype_export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--MODALS-->
<div class="modal" id="proptype_addedit_modal" role="dialog">
        <div class="modalbody">
            <h2 class="modalTitle">Property Type</h2>
            <?php
                echo form_open(url_to('erp.inventory.propertytype'),array(
                    "id"=>"proptype_addedit_form",
                    "class"=>"flex"
                ));
            ?>
                ...
                <div class="form-width-1 ">
                    <div class="form-group textRight ">
                        ...
                        <button class="btn bg-primary" type="button" id="proptype_addedit_btn" >Save</button>
                    </div>
                </div>
            </form>
        </div>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let proptype_modal=new ModalBox(document.getElementById("proptype_addedit_modal"));
        proptype_modal.init();

        document.getElementById("proptype_modal_invoker1").onclick=(evt)=>{
            document.getElementById("f_type_id").value="0";
            document.getElementById("f_type_name").value="";
            proptype_modal.show_modal();
        };

        let proptype_paintarea=document.querySelector(".table-paint-area");
        proptype_paintarea.onclick=(evt)=>{
            let target=evt.target;
            proptype_paintarea.querySelectorAll(".modalBtn").forEach((item)=>{
        ...
        let proptype_form=document.getElementById("proptype_addedit_form");
        let proptype_validator=new FormValidate(proptype_form);

        let proptype_lock=false;
        document.getElementById("proptype_addedit_btn").onclick=(evt)=>{
            if(!proptype_lock){
                proptype_lock=true;
                proptype_validator.validate(
                (params)=>{
                    proptype_form.submit();
                    proptype_lock=false;
                },
                (params)=>{
                    proptype_lock=false;
        ...
        let config=JSON.parse('<?php echo $propertytype_datatable_config; ?>');
