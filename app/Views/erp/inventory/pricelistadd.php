...
<div class="alldiv">
    <?php
        echo form_open(url_to('erp.inventory.pricelistadd'),array(
            "class"=>"flex",
            "id"=>"pricelist_add_form"
        ));
    ?>
        ...
        <div class="form-width-1">
            <div class="form-group textRight">
                ...
                <button class="btn bg-primary" type="button" id="pricelist_add_submit">Save</button>
            </div>
        </div>
    </form>
</div>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let form=document.getElementById("pricelist_add_form");
        let validator=new FormValidate(form);

        let lock=false;
        document.getElementById("pricelist_add_submit").onclick=function(evt){
            if(!lock){
                lock=true;
                validator.validate(
                (params)=>{
