...
<div class="alldiv">
    <ul class="tab_nav">
        ...
        <li><a type="button" class="tab_nav_item" data-src="finishedgood_attachment">Attachments</a></li>
        <li><a type="button" class="tab_nav_item" data-src="finishedgood_stockalert">Stock Alert</a></li>
    </ul>
    <div class="tab_content">
        <div class="tab_pane active" id="item_info">
            <div class="flex">
                <div class="form-width-1 text-right">
                    <a href="<?=url_to('erp.inventory.finishedgooddelete',$finished_good_id)?>" class="btn bg-danger del-confirm">Delete</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th>Name</th>
                                    <td><?php echo $finished_good->name; ?></td>
                                </tr>
                                <tr>
                                    <th>Code</th>
                                    <td><?php echo $finished_good->code; ?></td>
                                </tr>
                                <tr>
                                    <th>Group</th>
                                    <td><?php echo $finished_good->group_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Unit</th>
                                    <td><?php echo $finished_good->unit_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Brand</th>
                                    <td><?php echo $finished_good->brand_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Short Description</th>
                                    <td><?php echo $finished_good->short_desc; ?></td>
                                </tr>
                                <tr>
                                    <th>Long Description</th>
                                    <td><?php echo $finished_good->long_desc; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="tab_pane" id="finishedgood_attachment">
            <div class="flex">
                <div class="form-width-1">
                    <div class="file-uploader-frame" data-ajax-url="<?php echo url_to('erp.inventory.uploadfinishedgoodattachment').'?id='.$finished_good_id.'&' ;?>" >
                ...
                <div class="form-width-1">
                    <div class="table-responsive">
                        <table class="table" >
                            <tbody class="attachment-holder" data-ajaxdel-url="<?php echo url_to('erp.inventory.finishedgooddeleteattachment').'?' ;?>" >
                                <?php
        ...
        <div class="tab_pane" id="finishedgood_stockalert">
            <?php
                echo form_open(url_to("erp.inventory.finishedgoodstockalert",$finished_good_id),array(
