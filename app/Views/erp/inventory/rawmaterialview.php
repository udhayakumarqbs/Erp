...
<div class="alldiv">
    ...
    <div class="tab_content">
        <div class="tab_pane active" id="item_info">
            <div class="flex">
                <div class="form-width-1 text-right">
                    <a href="<?=url_to('erp.inventory.rawmaterialdelete',$raw_material_id)?>" class="btn bg-danger del-confirm">Delete</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Code</th>
                                    <td><?php echo $raw_material->code; ?></td>
                                </tr>
                                <tr>
                                    <th>Group</th>
                                    <td><?php echo $raw_material->group_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Unit</th>
                                    <td><?php echo $raw_material->unit_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Brand</th>
                                    <td><?php echo $raw_material->brand_name; ?></td>
                                </tr>
                                <tr>
                                    <th>Short Description</th>
                                    <td><?php echo $raw_material->short_desc; ?></td>
                                </tr>
                                <tr>
                                    <th>Long Description</th>
                                    <td><?php echo $raw_material->long_desc; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="tab_pane" id="rawmaterial_attachment">
            <div class="flex">
                <div class="form-width-1">
                    <div class="file-uploader-frame" data-ajax-url="<?php echo url_to('erp.inventory.rawmaterialattachment').'?id='.$raw_material_id.'&' ;?>" >
                ...
                <div class="form-width-1">
                    <div class="table-responsive">
                        <table class="table" >
                            <tbody class="attachment-holder" data-ajaxdel-url="<?php echo url_to('erp.inventory.rawmaterialdeleteattachment').'?' ;?>" >
                                <?php
        ...
        <div class="tab_pane" id="rawmaterial_stockalert">
            <?php
                echo form_open(url_to('erp.inventory.rawmaterialstockalert',$raw_material_id),array(
