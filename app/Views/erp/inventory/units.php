<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="#" id="unit_modal_invoker1" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.inventory.ajaxunitresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url() . 'erp/inventory/units-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/inventory/units-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url() . 'erp/inventory/units-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/inventory/units-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                            <li><a data-default-href="<?php echo base_url() . 'erp/inventory/units-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/inventory/units-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                        </ul>
...
<!--MODALS-->
<div class="modal" id="unit_addedit_modal" role="dialog">
    <div class="modalbody">
        <h2 class="modalTitle">Unit</h2>
        <?php
        echo form_open(url_to('erp.inventory.units'), array(
            "id" => "unit_addedit_form",
            "class" => "flex"
        ));
        ?>
        <input type="hidden" name="unit_id" id="f_unit_id" value="0" />
        <div class="form-width-1">
            <div class="form-group field-required ">
                <label class="form-label">Unit Name</label>
                <input type="text" class="form_control field-check" id="f_unit_name" name="unit_name" />
        ...
        <div class="form-width-1 ">
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="button" id="unit_addedit_btn">Save</button>
            </div>
        </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    let unit_modal = new ModalBox(document.getElementById("unit_addedit_modal"));
    unit_modal.init();

    document.getElementById("unit_modal_invoker1").onclick = (evt) => {
        document.getElementById("f_unit_id").value = "0";
        document.getElementById("f_unit_name").value = "";
        unit_modal.show_modal();
    };

    let unit_paintarea = document.querySelector(".table-paint-area");
    unit_paintarea.onclick = (evt) => {
        let target = evt.target;
        unit_paintarea.querySelectorAll(".modalBtn").forEach((item) => {
                ...
                if (xhr !== null && xhr !== undefined) {
                    ...
                    xhr.onreadystatechange = (evt) => {
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            ...
                            if (json['error'] == 0) {
                                let data = json['data'];
                                document.getElementById("f_unit_id").value = data['unit_id'];
                                document.getElementById("f_unit_name").value = data['unit_name'];
                                unit_modal.show_modal();
                            }
                        }
                    }
    ...
    let unit_form = document.getElementById("unit_addedit_form");
    let unit_validator = new FormValidate(unit_form);

    let unit_lock = false;
    document.getElementById("unit_addedit_btn").onclick = (evt) => {
        if (!unit_lock) {
            unit_lock = true;
    ...
    let config = JSON.parse('<?php echo $unit_datatable_config; ?>');
