<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.inventory.rawmaterialadd');?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
        <a href="<?php echo url_to('erp.inventory.rawmaterialimport');?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Import </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.inventory.rawmaterialsresponse').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                    <div class="formWidth">
                        <div class="selectBox poR" id="rawmaterial_filter_1" >
                    ...
                    <div class="formWidth">
                    <div class="selectBox poR" id="rawmaterial_filter_2" >
                            <div class="selectBoxBtn flex"> 
                    ...
                    <div class="formWidth">
                    <div class="selectBox poR" id="rawmaterial_filter_3" >
                            <div class="selectBoxBtn flex"> 
                    ...
                    <div class="formWidth">
                    <div class="multiSelectBox poR" id="rawmaterial_filter_4" >
            ...
            <div class="tableHeader flex">
                ...
                <!--export button-->
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/raw-materials-export?export=excel&';?>" href="<?php echo base_url().'erp/inventory/raw-materials-export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/raw-materials-export?export=pdf&';?>" href="<?php echo base_url().'erp/inventory/raw-materials-export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/inventory/raw-materials-export?export=csv&';?>" href="<?php echo base_url().'erp/inventory/raw-materials-export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $rawmaterial_datatable_config; ?>');
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("rawmaterial_filter_1");
            let filter_2=document.getElementById("rawmaterial_filter_2");
            let filter_3=document.getElementById("rawmaterial_filter_3");
            let filter_4=document.getElementById("rawmaterial_filter_4");
