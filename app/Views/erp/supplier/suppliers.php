<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?= url_to('erp.supplier.add') ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
        <a href="<?= url_to('erp.supplier.import') ?>" class="btn bg-success"><i class="fa fa-plus"></i> Import </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.supplier.ajax') . "?" ?>">
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="supplier_filter_1">
                ...
                <div class="formWidth">
                    <div class="multiSelectBox poR" id="supplier_filter_2">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url() . 'erp/supplier/supplier-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/supplier/supplier-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/supplier/supplier-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/supplier/supplier-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/supplier/supplier-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/supplier/supplier-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    let config = JSON.parse('<?php echo $supplier_datatable_config; ?>');
    ...
    if (config['filters'] !== null && config['filters'] !== undefined) {
        let filter_1 = document.getElementById("supplier_filter_1");
        let filter_2 = document.getElementById("supplier_filter_2");
        ...
        let multiselect_box_1 = new MultiSelectBox(filter_2);
        multiselect_box_1.init();
        multiselect_box_1.add_listener(datatable.filter, {
            type: "multiselect",
    ...
    let paintarea = datatable_elem.querySelector(".table-paint-area");
