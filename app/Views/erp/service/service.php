<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.service.serviceadd'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
    </div>
</div>
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.service.ajaxserviceresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="ticket_filter_1">
                        ...
                        <ul role="listbox" class="selectBox_Container alldiv">
                            <?php
                            foreach ($servicePriority_status as $key => $value) {
                            ?>
                ...
                <div class="formWidth">
                    <div class="selectBox poR" id="ticket_filter_2">
                        <div class="selectBoxBtn flex">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/service/service-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/service/service-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/service/service-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    if (config['filters'] !== null && config['filters'] !== undefined) {
        let filter_1 = document.getElementById("ticket_filter_1");
        let filter_2 = document.getElementById("ticket_filter_2");
