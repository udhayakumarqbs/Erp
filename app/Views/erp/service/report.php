...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.service.reportresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
                <h4>Service Scheduling Report</h4>
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-report-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/service/service-report-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-report-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/service/service-report-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/service/service-report-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/service/service-report-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    // let statusOne=status[0].total;
    // let statusTwo=status[1].total;
    // let statusThree=status[2].total;
    const data = {
        labels: ['Not Started', 'Ongoing', 'Complete', 'Cancelled'],
        datasets: [{
            label: '# of Votes',
            data: [12, 19, 3, 5],
            borderWidth: 1,
    ...
    function handleHover(event, legendItem) {
        // // Handle hover event
        // console.log('Hovered over: ', legendItem.text);
    }
