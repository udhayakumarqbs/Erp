<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="#" id="tax_modal_invoker1" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.finance.ajaxtaxresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url() . 'erp/finance/tax-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/finance/tax-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url() . 'erp/finance/tax-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/finance/tax-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                            <li><a data-default-href="<?php echo base_url() . 'erp/finance/tax-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/finance/tax-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                        </ul>
...
<!--MODALS-->
<div class="modal" id="tax_addedit_modal" role="dialog">
    <div class="modalbody">
        <h2 class="modalTitle">Tax</h2>
        <?php
        echo form_open(url_to('erp.finance.tax'), array(
            "id" => "tax_addedit_form",
            "class" => "flex"
        ));
        ?>
        <input type="hidden" name="tax_id" id="f_tax_id" value="0" />
        <div class="form-width-1">
            <div class="form-group field-required ">
                <label class="form-label">Tax Name</label>
                <input type="text" class="form_control field-check" id="f_tax_name" name="tax_name" />
        ...
        <div class="form-width-1">
            <div class="form-group field-number">
                ...
                <input type="text" class="form_control field-check" id="f_tax_percent" name="tax_percent" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1 ">
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="button" id="tax_addedit_btn">Save</button>
            </div>
        </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    let tax_modal = new ModalBox(document.getElementById("tax_addedit_modal"));
    tax_modal.init();

    document.getElementById("tax_modal_invoker1").onclick = (evt) => {
        document.getElementById("f_tax_id").value = "0";
        document.getElementById("f_tax_name").value = "";
        document.getElementById("f_tax_percent").value = "";
        tax_modal.show_modal();
    };

    let tax_paintarea = document.querySelector(".table-paint-area");
    tax_paintarea.onclick = (evt) => {
        let target = evt.target;
        tax_paintarea.querySelectorAll(".modalBtn").forEach((item) => {
                    ...
                    xhr.onreadystatechange = (evt) => {
                        if (xhr.readyState == 4 && xhr.status == 200) {
                            ...
                            if (json['error'] == 0) {
                                ...
                                document.getElementById("f_tax_name").value = data['tax_name'];
                                document.getElementById("f_tax_percent").value = data['percent'];
                                tax_modal.show_modal();
                            }
                        }
                    }
    ...
    let tax_form = document.getElementById("tax_addedit_form");
    let tax_validator = new FormValidate(tax_form);

    let tax_lock = false;
    document.getElementById("tax_addedit_btn").onclick = (evt) => {
        if (!tax_lock) {
            tax_lock = true;
            tax_validator.validate(
                (params) => {
                    tax_form.submit();
                    tax_lock = false;
                },
    ...
    let config = JSON.parse('<?php echo $tax_datatable_config; ?>');
