        ...
        <div class="tab_pane active" id="invoice_info">
            <div class="flex">
                <div class="form-width-1 text-right">
                    ...
                    <a <?=url_to('erp.sale.invoice.delete',$invoice_id)?> class="btn bg-danger del-confirm">Delete</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Status</th>
                                    <td><span class="st <?php echo $invoice_status_bg[$invoice->status]; ?>"><?php echo $invoice_status[$invoice->status]; ?></span></td>
                                </tr>
                                <tr>
                                    <th>Discount</th>
