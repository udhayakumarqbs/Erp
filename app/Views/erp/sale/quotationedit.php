...
<div class="alldiv">
    <form action="<?= url_to('erp.sale.quotations.edit.post', $quote_id) ?>" class="flex" method="post" id="quotation_edit_form">
        <div class="form-width-1 textCenter">
            <div class="form-group">
                <span class="st st_danger">If you edit this quotation it's prices will be updated based on the price list</span>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-ajax " data-ajax-url="<?php echo url_to('erp.sale.quotations.quotation_code_unique') . '?id=' . $quote_id . '&'; ?>">
                <label class="form-label">Quotation Code</label>
                <input type="text" name="code" value="<?php echo $quotation->code; ?>" class="form_control field-check" readonly />
        ...
        <div class="form-width-2">
            <div class="form-group">
                ...
                <input type="text" name="quote_subject" value="<?= $quotation->subject; ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="date" name="quote_date" value="<?php echo $quotation->quote_date; ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            ...
            <div class="form-group field-required">
                ...
                <div class="ajaxselectBox poR" id="customer_ajax_select_box" data-ajax-url="<?php echo url_to('erp.sale.getCustomer') ?>">
                    <div class="ajaxselectBoxBtn flex">
                        <div class="textFlow" data-default="select customer"><?php echo $quotation->name; ?></div>
                        <button class="close" type="button"><i class="fa fa-close"></i></button>
                        <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" class="ajaxselectBox_Value field-check" name="cust_id" id="cust_id" value="<?php echo $quotation->cust_id; ?>">
                    </div>
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="text" id="quote_email" name="quote_email" class="form_control field-check" value=<?= $quotation->email; ?> readonly />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group">
                ...
                <input type="text" id="quote_phone" name="quote_phone" class="form_control field-check" value=<?= $quotation->phone; ?> readonly />
                <p class="error-text"></p>
            </div>
        </div>
        ...
        <div class="form-width-2">
            <div class="form-group field-money">
                ...
                <input type="text" id="quote_trans_charge" name="trans_charge" value="<?php echo $quotation->trans_charge; ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="text" name="payment_terms" value="<?php echo $quotation->payment_terms; ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1">
            <div class="form-group">
                ...
                <textarea rows="3" name="terms_condition" id="termsCondition" class="form_control"><?php echo $quotation->terms_condition; ?></textarea>
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1">
            ...
            <table class="table">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="discount" id="quote_discount" value="<?php echo $quotation->discount; ?>" class="form_control field-check" /></td>
                    </tr>
                    <tr>
        ...
        <div class="form-width-1">
            <div class="form-group textRight ">
                <a class="btn outline-danger" href="<?php echo url_to('erp.sale.quotations'); ?>">Cancel</a>
                <button class="btn bg-primary" type="button" id="quotation_edit_btn">Save</button>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('customer_ajax_select_box').addEventListener('change', function() {
    ...
    let form = document.getElementById("quotation_edit_form");
    let validator = new FormValidate(form);

    let lock = false;
    document.getElementById("quotation_edit_btn").onclick = function(evt) {
        if (!lock) {
            lock = true;
            validator.validate(
                (params) => {
