...
<div class="alldiv">
    <form action="<?= url_to('erp.sale.estimates.edit.post', $estimate_id) ?>" class="flex" id="estimate_edit_form" method="post">
        <div class="form-width-1 textCenter">
            <div class="form-group">
                <span class="st st_danger">If you edit this estimate it's prices will be updated based on the price list</span>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-ajax " data-ajax-url="<?php echo url_to('erp.sale.ajaxEstimateCodeUnique') . '?id=' . $estimate_id . '&'; ?>">
                <label class="form-label">Estimate Code</label>
                <input type="text" name="code" value="<?php echo $estimate->code; ?>" class="form_control field-check" readonly />
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="date" name="estimate_date" value="<?php echo $estimate->estimate_date; ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <div class="ajaxselectBox poR" id="customer_ajax_select_box" data-ajax-url="<?php echo url_to('erp.sale.getCustomer') ?>">
                    <div class="ajaxselectBoxBtn flex">
                        <div class="textFlow" data-default="select customer"><?php echo $estimate->name; ?></div>
                        <button class="close" type="button"><i class="fa fa-close"></i></button>
                        <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" class="ajaxselectBox_Value field-check" name="cust_id" id = "cust_id" value="<?php echo $estimate->cust_id; ?>">
                    </div>
        ...
        <div class="form-width-1">
            <div class="form-group ">
                ...
                <textarea rows="3" name="terms_condition" id="termsCondition" class="form_control"><?php echo $estimate->terms_condition; ?></textarea>
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1">
        ...
        <div class="form-width-1">
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="button" id="estimate_edit_btn">Save</button>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
  ...
  //Address Edit box modal
    ...
    let form = document.getElementById("estimate_edit_form");
    let validator = new FormValidate(form);

    let lock = false;
    document.getElementById("estimate_edit_btn").onclick = function(evt) {
        if (!lock) {
            lock = true;
            validator.validate(
                (params) => {
    ...
    function calculateSubTotal() {
        ...
        document.getElementById("estimate_total").textContent = total.toFixed(2);
    }
