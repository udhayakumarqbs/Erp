<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?= url_to('erp.add.creditnoteadd'); ?>" class="btn bg-success" type="button"><i class="fa fa-plus"></i>Add</a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.sale.ajaxcreditnotes') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
...
<script type="text/javascript">
    ...
    let config = JSON.parse('<?php echo $credit_datatable_config; ?>');
