<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.sale.orders.orderadd') ; ?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.sale.orders.ajaxfetch').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?=url_to('erp.sale.order.export').'?export=excel&';?>" href="<?= url_to('erp.sale.order.export').'?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?= url_to('erp.sale.order.export').'?export=pdf&';?>" href="<?=url_to('erp.sale.order.export').'?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?= url_to('erp.sale.order.export').'?export=csv&';?>" href="<?=url_to('erp.sale.order.export').'?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
