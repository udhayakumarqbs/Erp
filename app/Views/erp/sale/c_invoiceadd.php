...
<div class="alldiv">
    ...
    <div class="form-width-2">
        <div class="form-group field-required">
            ...
            <input type="date" name="invoice_date" value="<?php echo date("Y-m-d"); ?>" class="form_control field-check" />
            <p class="error-text"></p>
        </div>
    </div>
    <div class="form-width-2">
    ...
    <div class="form-width-2">
        <div class="form-group field-required">
            ...
            <input type="date" name="invoice_expiry" class="form_control field-check" />
            <p class="error-text"></p>
        </div>
    </div>
    <div class="form-width-2">
