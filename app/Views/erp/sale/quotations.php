<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?= url_to('erp.sale.quotation.add') ; ?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.sale.quotations.datatable').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="quote_filter_1" >
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo url_to('erp.sale.quotations.export').'?export=excel&';?>" href="<?php echo url_to('erp.sale.quotations.export').'?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo url_to('erp.sale.quotations.export').'?export=pdf&';?>" href="<?php echo url_to('erp.sale.quotations.export').'?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo url_to('erp.sale.quotations.export').'?export=csv&';?>" href="<?php echo url_to('erp.sale.quotations.export').'?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $quotation_datatable_config; ?>');
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("quote_filter_1");
