        ...
        <div class="tab_pane active" id="credit_info">
            <div class="flex">
                <div class="form-width-1 text-right">
                    ...
                    if ($creditnote->other_charge == $used_amount['amount'] && $used_amount['amount'] != NULL): ?>
                        <a href="<?= url_to('erp.sale.invocieapply', $credit_id); ?>" class="btn bg-primary d-none">Apply to Invoice</a>
                    <?php elseif ($customer_invoice_id != NULL): ?>
                        <a href="<?= url_to('erp.sale.invocieapply', $credit_id); ?>" class="btn bg-primary">Apply to Invoice</a>
                    <?php else: ?>
                        <?php
                        session()->setFlashdata('op_error', 'There are no available invoices for this customer.');
                        ?>
                    <?php endif; ?>
                    ...
                    <div class="table_responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Credit Used</th>
                                    <td><?php echo $used_amount['amount'] ?? 0; ?></td>
                                </tr>
                                <tr>
                                    <th>Credits Remaining</th>
                                    <td><?php
                                        $balance_amount = $creditnote->other_charge - $used_amount['amount'];
                    ...
                    <div class="table_responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $inc = 1;
                                foreach ($credited_invoice as $row) {
                                ?>
                                    <tr>
                                        <td><?php echo $inc; ?></td>
...
<div class="modal" id="email_addedit_modal" role="dialog">
    <div class="modalbody">
        ...
        <?php
        echo form_open(url_to('erp.sale.invoice.view.mailsend', $credit_id, 'credit_notes'), array(
