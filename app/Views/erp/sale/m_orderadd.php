<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.sale.orders'); ?>" class="btn bg-success"><i class="fa fa-reply"></i> Back </a>
    </div>
</div>

<div class="alldiv">
    <form action="<?= url_to('erp.sale.orders.orderadd') ?>" method="post" id="order_add_form" class="flex">
        <div class="form-width-2">
            <div class="form-group field-ajax " data-ajax-url="<?php echo url_to('erp.sale.orders.ajax_order_code_unique') . '?'; ?>">
                <?php
                $newCode = "ORD-" . sprintf('%03d', $maxCode + 1);
                ?>
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="date" name="order_date" id="order_date" value="<?php echo date("Y-m-d"); ?>" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
        ...
        <div class="form-width-2">
            <div class="form-group field-money">
                ...
                <input type="text" id="order_trans_charge" name="trans_charge" value="0" class="form_control field-check" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                ?>
                <input type="date" name="order_expiry" id="seventh_day" class="form_control field-check" value="<?= $sevenDaysLater ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-2">
        ...
        <div class="form-width-3">
            <div class="form-group" id="order_price_list" data-ajax-url="<?php echo url_to('erp.sale.getPriceData'); ?>">
            ...
            <table class="table">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="discount" id="order_discount" value="0.00" class="form_control field-check" /></td>
                    </tr>
                    <tr>
        ...
        <div class="form-width-1">
            <div class="form-group textRight ">
                <a class="btn outline-danger" href="<?php echo url_to('erp.sale.orders'); ?>">Cancel</a>
                <button class="btn bg-primary" type="button" id="order_add_btn">Save</button>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    let form = document.getElementById("order_add_form");
    let validator = new FormValidate(form);

    let lock = false;
    document.getElementById("order_add_btn").onclick = function(evt) {
        if (!lock) {
            lock = true;
            validator.validate(
                (params) => {
    ...
    document.getElementById('order_date').addEventListener('change', function() {
        var orderDateValue = this.value;
        var seventhDay = new Date(orderDateValue);
