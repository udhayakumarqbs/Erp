<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?= url_to('erp.sale.estimates'); ?>" class="btn bg-success"><i class="fa fa-reply"></i> Back </a>
    </div>
</div>
<div class="alldiv">
    <ul class="tab_nav">
        <li><a type="button" class="tab_nav_item active" data-src="est_info">Info</a></li>
        <li><a type="button" class="tab_nav_item" data-src="est_attachment">Attachments</a></li>
        <li><a type="button" class="tab_nav_item" data-src="est_notify">Notify</a></li>
    </ul>
    <div class="tab_content">
        <div class="tab_pane active" id="est_info">
            <div class="flex">
                <div class="form-width-1 text-right">
                    ...
                    <a href="<?= url_to('erp.sale.estimates.delete', $estimate_id); ?>" class="btn bg-danger del-confirm">Delete</a>
                </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $estimate->billing_addr; ?></td>
                                </tr>
                                <tr>
                                    <th>Shipping Address</th>
                                    <td><?php echo $estimate->shipping_addr; ?></td>
                                </tr>
                                <tr>
                                    <th>Estimate date</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $estimate->terms_condition; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="tab_pane" id="est_attachment">
            <div class="flex">
                <div class="form-width-1">
                    <div class="file-uploader-frame" data-ajax-url="<?php echo url_to('erp.sale.upload.attachments') . '?id=' . $estimate_id . '&'; ?>">
                ...
                <div class="form-width-1">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody class="attachment-holder" data-ajaxdel-url="<?php echo url_to('erp.sale.delete.attachments') . '?'; ?>">
                                <?php
                                foreach ($attachments as $attach) {
                                ?>
                                    <tr>
                                        <td><a target="_BLANK" download class="text-primary" href="<?php echo get_attachment_link('estimate') . $attach['filename']; ?>"><?php echo $attach['filename']; ?></a></td>
        ...
        <div class="tab_pane" id="est_notify">
            <div class="flex">
                ...
                <div class="form-width-1">
                    <div class="datatable" data-ajax-url="<?php echo url_to('erp.sale.ajaxEstimatenotifyResponse') . '?estid=' . $estimate_id . '&'; ?>">
                        ...
                        <div class="tableHeader flex">
                            ...
                            <div class="formWidth textRight">
                                ...
                                <div class="export_container poF">
                                    <ul class="exportUl">
                                        <li><a data-default-href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=excel&estid=' . $estimate_id . '&'; ?>" href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=excel&estid=' . $estimate_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                                        <li><a data-default-href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=pdf&estid=' . $estimate_id . '&'; ?>" href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=pdf&estid=' . $estimate_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                                        <li><a data-default-href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=csv&estid=' . $estimate_id . '&'; ?>" href="<?php echo url_to('erp.sale.estimateNotifyExport') . '?export=csv&estid=' . $estimate_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                                    </ul>
...
<div class="modal" id="notify_addedit_modal" role="dialog">
    <div class="modalbody">
        ...
        <form action="<?= url_to('erp.sale.EstimateNotifyAdd', $estimate_id) ?>" method="POST" id="notify_addedit_form" class="flex modal-scroll-form">
...
<div class="modal" id="email_addedit_modal" role="dialog">
    <div class="modalbody">
        ...
        <?php
        echo form_open(url_to('erp.sale.invoice.view.mailsend', $estimate_id, 'estimates'), array(
