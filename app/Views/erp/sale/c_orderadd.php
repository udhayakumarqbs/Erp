   ...
   <form action="<?= url_to('erp.sale.orders.orderadd')?>" method="post" id="order_add_form" class="flex">
        ...
        <div class="form-width-2">
            <div class="form-group field-required" >
                ...
                <input type="date" name="order_date" value="<?php echo date("Y-m-d"); ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
        ...
        <div class="form-width-2">
            <div class="form-group field-required" >
                ...
                <input type="date" name="order_expiry" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
        ...
        <div class="form-group" id="order_property" >
            ...
            <div class="ajaxselectBox poR" data-ajax-url="<?php echo url_to('erp.sale.orders.ajaxfetchproperties') ;?>" >
                <div class="ajaxselectBoxBtn flex"> 
        ...
        <div class="form-width-2">
        <div class="form-group" id="order_unit" data-ajax-url="<?php echo url_to('erp.sale.orders.ajaxfetchpropertyunits') ;?>" >
        ...
        order_property_box.add_listener((params)=>{
            ...
            if(property_id!==null && property_id!==undefined && property_id!==""){
                ...
                if(xhr!==null || xhr!==undefined){
                    xhr.open("GET",ajax_url+"?property_id="+property_id,true);
                    xhr.send(null);
