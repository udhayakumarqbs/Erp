<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.setting.templateview'); ?>" class="btn bg-success"><i class="fa fa-plus"></i>
            View</a>
    </div>
</div>
<style>
...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.emailtemplate_Data_table') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
