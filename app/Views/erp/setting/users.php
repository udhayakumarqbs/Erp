<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.users.add'); ?>" class="btn bg-primary"><i class="fa fa-plus"></i> Add Users</a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.setting.ajaxusersresponse').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
                    ...
                    <div class="selectBox poR" id="lead_filter_1" >
                        <div class="selectBoxBtn flex"> 
                            <div class="textFlow" data-default="Select Role">Select Role</div>
                                ...
                                <input type="hidden"  class="selectBox_Value field-check" name="role" value="" >
                            </div>
            ...
            <div class="tableHeader flex">
                ...
                <!--export button-->
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url().'erp/setting/user-export?export=excel&';?>" href="<?php echo base_url().'erp/setting/user-export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/setting/user-export?export=pdf&';?>" href="<?php echo base_url().'erp/setting/user-export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png'; ?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/setting/user-export?export=csv&';?>" href="<?php echo base_url().'erp/setting/user-export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
