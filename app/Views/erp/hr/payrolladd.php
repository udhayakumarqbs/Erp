...
<div class="alldiv">
    <?php
        echo form_open(url_to('erp.hr.payrolladd'),array(
            "class"=>"flex",
            "id"=>"payroll_add_form"
        ));
    ?>
        ...
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="date" name="payment_date" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="date" name="payment_from" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="date" name="payment_to" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2" >
            <div class="form-group ">
                ...
                <div class="multiSelectBox poR">
                    <div class="multiSelectBoxBtn">
                        ...
                        <input type="hidden" name="deductions" value="" class="multiSelectInput field-check" >
                    </div>
            ...
            <div class="form-group ">
                ...
                <div class="multiSelectBox poR">
                    <div class="multiSelectBoxBtn">
                        <div class="Multi_InputContainer" data-default="Select Group">Select Group</div>
                        <button class="drops2" type="button"><i class="fa fa-caret-down"></i></button>
                        <input type="hidden" name="additions" value="" class="multiSelectInput field-check" >
                    </div>
                    <div role="comboBox" class="MultiselectBox_Container">
                        <?php
        ...
        <div class="form-width-1">
            <div class="form-group textRight">
                ...
                <button class="btn bg-primary" type="button" id="payroll_add_submit">Save</button>
            </div>
        </div>
    </form>
</div>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let form=document.getElementById("payroll_add_form");
        let validator=new FormValidate(form);

        let lock=false;
        document.getElementById("payroll_add_submit").onclick=function(evt){
            if(!lock){
                lock=true;
                validator.validate(
                (params)=>{
