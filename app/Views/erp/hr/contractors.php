<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.hr.contractoradd') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
        <a href="<?php echo url_to('erp.hr.contractorimport') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Import </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.hr.ajaxcontractorsresponse').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="tableHeader flex">
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?php echo base_url().'erp/hr/contractor-export?export=excel&';?>" href="<?php echo base_url().'erp/hr/contractor-export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/hr/contractor-export?export=pdf&';?>" href="<?php echo base_url().'erp/hr/contractor-export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/hr/contractor-export?export=csv&';?>" href="<?php echo base_url().'erp/hr/contractor-export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let contractor_paintarea=document.querySelector(".table-paint-area");
        ...
        let config=JSON.parse('<?php echo $contractor_datatable_config; ?>');
        ...
        function load_active_toggler_1(params){
            contractor_paintarea.querySelectorAll(".active-toggler-1").forEach((item)=>{
