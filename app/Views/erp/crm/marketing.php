<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.crm.marketingadd'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
        <!-- <a href="<?php //echo url_to('erp.crm.marketingimport'); ?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Import </a> -->
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.crm.ajaxmarketingresponse').'?'; ?>">
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="marketing_filter_1">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url() . 'erp/crm/marketing-export?export=excel&'; ?>" href="<?php echo base_url() . 'erp/crm/marketing-export?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/crm/marketing-export?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/crm/marketing-export?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo base_url() . 'erp/crm/marketing-export?export=csv&'; ?>" href="<?php echo base_url() . 'erp/crm/marketing-export?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    let config = JSON.parse('<?php echo $marketing_datatable_config; ?>');
    ...
    let paint_area = document.querySelector(".table-paint-area");

    function load_active_toggler_1(params) {
        paint_area.querySelectorAll(".active-toggler-1").forEach((item) => {
    ...
    if (config['filters'] !== null && config['filters'] !== undefined) {
        let filter_1 = document.getElementById("marketing_filter_1");
