<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.crm.customeradd') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add </a>
        <a href="<?php echo url_to('erp.crm.customerimport') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Import </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.crm.ajaxcustomersresponse').'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="multiSelectBox poR" id="customer_filter_1">
            ...
            <div class="tableHeader flex">
                ...
                <!--export button-->
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                        <li><a data-default-href="<?php echo base_url().'erp/crm/customer-export?export=excel&';?>" href="<?php echo base_url().'erp/crm/customer-export?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/crm/customer-export?export=pdf&';?>" href="<?php echo base_url().'erp/crm/customer-export?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?php echo base_url().'erp/crm/customer-export?export=csv&';?>" href="<?php echo base_url().'erp/crm/customer-export?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("customer_filter_1");

            let multiselect_box_1=new MultiSelectBox(filter_1);
            multiselect_box_1.init();
            multiselect_box_1.add_listener(datatable.filter,{type:"multiselect",column:config['filters'][0]});
