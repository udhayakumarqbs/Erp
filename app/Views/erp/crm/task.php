<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.crm.taskadd');
                    ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a>
    </div>
</div>
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.crm.ajaxtaskresponse') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
                ...
                <div class="formWidth">
                    <div class="selectBox poR" id="ticket_filter_1">
                        ...
                        <ul role="listbox" class="selectBox_Container alldiv">
                            <?php
                            foreach ($taskpriority_status as $key => $value) {
                            ?>
