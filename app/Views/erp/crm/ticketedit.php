...
<div class="alldiv">
    <?php
    echo form_open(url_to('erp.crm.ticketedit', $ticket_id), array(
        "class" => "flex",
        "id" => "ticket_edit_form"
    ));
    ?>
    <div class="form-width-2">
        <div class="form-group field-required ">
            ...
            <input type="text" name="subject" value="<?php echo $ticket->subject; ?>"
        ...
        <div class="form-group field-required">
            ...
            <div class="selectBox poR">
                <div class="selectBoxBtn flex">
                    ...
                    <input type="hidden" class="selectBox_Value field-check" name="priority"
    ...
    <div class="form-width-2">
        <div class="form-group field-required">
            ...
            <div class="ajaxselectBox poR" data-ajax-url="<?php echo url_to('erp.crm.ajaxfetchcustomersforticktes'); ?>">
                <div class="ajaxselectBoxBtn flex">
                    <div class="textFlow" data-default="select customer"><?php echo $ticket->customer; ?></div>
                    <button class="close" type="button"><i class="fa fa-close"></i></button>
                    <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                    <input type="hidden" id="contact_input" class="ajaxselectBox_Value field-check" name="customer"
                        value="<?php echo $ticket->cust_id; ?>">
                </div>
    ...
    <div class="form-width-2">
        <div class="form-group">
            ...
            <select class="form_control" id="projects_list" name="project"
                style="width: 509px !important;">
            </select>
        </div>
    </div>
    ...
    <div class="form-width-2">
        <div class="form-group field-required">
            ...
            <div class="ajaxselectBox poR" data-ajax-url="<?php echo url_to('erp.crm.ajaxFetchUsers'); ?>">
                <div class="ajaxselectBoxBtn flex">
                    <div class="textFlow" data-default="assign to"><?php echo $ticket->assigned; ?></div>
                    <button class="close" type="button"><i class="fa fa-close"></i></button>
                    <button class="drops" type="button"><i class="fa fa-caret-down"></i></button>
                    <input type="hidden" class="ajaxselectBox_Value field-check" name="assigned_to"
    ...
    <div class="form-width-1">
        <div class="form-group field-required ">
            ...
            <textarea rows="3" name="problem"
                class="form_control field-check"><?php echo $ticket->problem; ?></textarea>
            <p class="error-text"></p>
        </div>
    </div>
    <div class="form-width-1">
        <div class="form-group textRight">
            ...
            <button class="btn bg-primary" type="button" id="ticket_edit_submit">Update</button>
        </div>
    </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    let form = document.getElementById("ticket_edit_form");
    let validator = new FormValidate(form);

    let lock = false;
    document.getElementById("ticket_edit_submit").onclick = function (evt) {
        if (!lock) {
            lock = true;
            validator.validate(
                (params) => {
                    ...
                    if (response.success) {
                        ...
                        if (data.length > 0) {
                            ...
                            data.forEach((value, index) => {
                                li += `<option value="${value.project_id}" ${(value.project_id == project_id) ? "selected" : ""} >${value.name}</option>`;
                            })
