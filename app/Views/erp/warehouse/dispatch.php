<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <!-- <a href="<?php echo url_to('warehouse.dispatch.add'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> Add </a> -->
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.ajaxresponse.warehouse.datatable') . "?" ?>">
        <div class="filterBox">
            <div class="flex">
                ...
                <div class="formWidth">
                    <div class="selectBox poR" id="equipment_filter_1">
                        ...
                        <ul role="listbox" class="selectBox_Container alldiv">
                            <?php
                            foreach ($dispatch_status as $key => $status) {
                            ?>
        ...
        <div class="tableHeader flex">
            <div class="formWidth">
                <div class="selectBox poR bulkaction" data-ajax-url="<?= url_to('erp.ajaxresponse.warehouse.datatable') . "?" ?>">
                    <div class="selectBoxBtn flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=excel&'; ?>" href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=pdf&'; ?>" href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=csv&'; ?>" href="<?php echo url_to('erp.warehosue.dispatch.exporter').'?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    let config = JSON.parse('<?php echo $dispatch_datatable_config; ?>');
