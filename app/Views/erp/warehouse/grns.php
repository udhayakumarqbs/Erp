...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.grn.datatable').'?';?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox poR" id="grn_filter_1">
                        ...
                        <ul role="listbox" class="selectBox_Container alldiv">
                            <?php
                                foreach ($grn_status as $key=>$value) {
                                    ?>
            ...
            <div class="tableHeader flex">
                <div class="formWidth">
                    <div class="selectBox poR bulkaction" data-ajax-url="<?= url_to('erp.grn.datatable').'?';?>" >
                        <div class="selectBoxBtn flex"> 
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?= url_to('erp.grn.exportgrn').'?export=excel&';?>" href="<?= url_to('erp.grn.exportgrn').'?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?= url_to('erp.grn.exportgrn').'?export=pdf&';?>" href="<?= url_to('erp.grn.exportgrn').'?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?= url_to('erp.grn.exportgrn').'?export=csv&';?>" href="<?= url_to('erp.grn.exportgrn').'?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $grn_datatable_config; ?>');
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("grn_filter_1");
