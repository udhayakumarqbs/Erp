<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?= url_to('erp.warehouse.managestock.addview') ;?>" class="btn bg-success" ><i class="fa fa-plus" ></i> Add Stock </a>
    </div>
</div>

<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.warehouse.managestock.datatable') .'?' ;?>" >
        <div class="filterBox">
            <div class="flex">
            ...
            <div class="flex filterBox_container">
                <div class="formWidth">
                    <div class="selectBox stock_product_type poR" id="managestock_filter_1">
            ...
            <div class="tableHeader flex">
                <div class="formWidth">
                    <div class="selectBox poR bulkaction" data-ajax-url="<?= url_to('erp.warehouse.managestock.datatable') .'?' ;?>" >
                        <div class="selectBoxBtn flex"> 
                ...
                <div class="formWidth textRight">
                    ...
                    <div class="export_container poF">
                        <ul class="exportUl">
                            <li><a data-default-href="<?= url_to('erp.managestock.exporter').'?export=excel&';?>" href="<?= url_to('erp.managestock.exporter').'?export=excel&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/xls.png' ;?>" alt="excel" >EXCEL</a></li>
                            <li><a data-default-href="<?= url_to('erp.managestock.exporter').'?export=pdf&';?>" href="<?= url_to('erp.managestock.exporter').'?export=pdf&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/pdf.png' ;?>" alt="pdf" >PDF</a></li>
                            <li><a data-default-href="<?= url_to('erp.managestock.exporter').'?export=csv&';?>" href="<?= url_to('erp.managestock.exporter').'?export=csv&';?>" target="_BLANK" ><img src="<?php echo base_url().'assets/images/icons/csv.png' ;?>" alt="csv" >CSV</a></li>
                        </ul>
...
<!--SCRIPT WORKS -->
    ...
    <script type="text/javascript">
        ...
        let config=JSON.parse('<?php echo $managestock_datatable_config; ?>');
        ...
        if(config['filters']!==null && config['filters']!==undefined){
            let filter_1=document.getElementById("managestock_filter_1");
