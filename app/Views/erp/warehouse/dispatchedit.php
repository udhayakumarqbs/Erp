...
<div class="alldiv">
    <form action="<?= url_to('erp.dispatch.edit.post',$dispatch_id); ?>" method="post" class="flex" id="dispatch_add_form">
    <div class="form-width-2">
            <div class="form-group field-ajax">
                <label class="form-label">Order Code</label>
                <input type="text" class="form_control field-check" name="order_code" value="<?php echo $dispatch->order_code; ?>" disabled/>
                <input name="order_code" value="<?php echo $dispatch->order_code; ?>" hidden/>
        ...
        <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="text" class="form_control field-check" name="customer_name" value="<?php echo $dispatch->customer; ?>" disabled/>
                <input name="customer_name" value="<?php echo $dispatch->customer; ?>" hidden/>
                <input name="cust_id" value="<?php echo $dispatch->cust_id; ?>" hidden/>
                <p class="error-text"></p>
            </div>
        </div>
       ...
       <div class="form-width-2">
            <div class="form-group field-required">
                ...
                <input type="datetime-local" class="form_control field-check" name="delivery_date" value="<?php echo $dispatch->delivery_date; ?>" />
                <p class="error-text"></p>
            </div>
        </div>
        ...
        <div class="form-width-1">
            <div class="form-group field-required ">
                ...
                <textarea rows="3" name="dispatch_desc" class="form_control field-check" value=""><?php echo $dispatch->description; ?></textarea>
                <p class="error-text"></p>
            </div>
        </div>
        <div class="form-width-1">
            <div class="form-group textRight ">
                ...
                <button class="btn bg-primary" type="submit" id="dispatch_add_btn">Save</button>
            </div>
        </div>
    </form>
</div>
