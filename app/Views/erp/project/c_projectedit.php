    ...
    ?>
        ...
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="units" value="<?php echo $project->units; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
        <div class="form-group field-required ">
            ...
            <div class="selectBox poR">
                <div class="selectBoxBtn flex"> 
                    ...
                    <input type="hidden"  class="selectBox_Value field-check" name="type_id" value="<?php echo $project->type_id; ?>" >
                </div>
            ...
            <div class="form-group field-required">
                ...
                <div class="multiSelectBox poR">
                    <div class="multiSelectBoxBtn">
                        ...
                        <input type="hidden" name="amenity" value="<?php echo $project->amenities; ?>" class="multiSelectInput field-check" >
                    </div>
        ...
        <div class="form-group" >
            ...
            <div class="ajaxselectBox poR" data-ajax-url="<?php echo url_to('erp.crm.ajaxfetchcustomers'); ?>" >
                <div class="ajaxselectBoxBtn flex"> 
                    <div class="textFlow" data-default="select customer"><?php
        ...
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="address" value="<?php echo $project->address; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="city" value="<?php echo $project->city; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="state" value="<?php echo $project->state; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="country" value="<?php echo $project->country; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        <div class="form-width-2">
            <div class="form-group field-required ">
                ...
                <input type="text" name="zipcode" value="<?php echo $project->zipcode; ?>" class="form_control field-check" />
                <p class="error-text" ></p>
            </div>
        </div>
        ...
        <div class="form-width-1">
            <div class="form-group textRight">
                ...
                <button class="btn bg-primary" type="button" id="project_edit_submit">Save</button>
            </div>
        </div>
    </form>
</div>
