	...
	<div class="tab_content">
		<div class="tab_pane active" id="project_info">
			<div class="flex">
				<div class="form-width-1 text-right">
					<a href="<?=url_to('erp.project.projectdelete',$project_id)?>" class="btn bg-danger del-confirm">Delete</a>
				</div>
						...
						<div class="tableHeader flex">
							...
							<div class="formWidth textRight">
								...
								<div class="export_container poF">
									<ul class="exportUl">
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-expense-export?export=excel&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-expense-export?export=excel&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-expense-export?export=pdf&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-expense-export?export=pdf&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-expense-export?export=csv&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-expense-export?export=csv&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
									</ul>
		...
		<div class="tab_pane" id="project_rawmaterial">
			<div class="flex">
				...
				<div class="form-width-1">
					<div class="datatable" id="project_rawmaterial_dt" data-ajax-url="<?php echo url_to('erp.project.ajaxprojectrawmaterialresponse') . '?projectid=' . $project_id . '&'; ?>">
						<div class="tableHeader flex">
							<div class="formWidth">
								<div class="selectBox poR bulkaction" data-ajax-url="">
									<div class="selectBoxBtn flex">
					...
					<div class="datatable" id="project_testing_dt" data-ajax-url="<?php echo url_to('erp.project.ajaxProjectTestingResponse') . '?projectid=' . $project_id . '&'; ?>">
						<div class="tableHeader flex">
							...
							<div class="formWidth textRight">
								...
								<div class="export_container poF">
									<ul class="exportUl">
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-testing-export?export=excel&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-testing-export?export=excel&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-testing-export?export=pdf&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-testing-export?export=pdf&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
										<li><a data-default-href="<?php echo base_url() . 'erp/project/project-testing-export?export=csv&' . 'projectid=' . $project_id . '&'; ?>" href="<?php echo base_url() . 'erp/project/project-testing-export?export=csv&' . 'projectid=' . $project_id . '&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
									</ul>
									<a type="button" class="closeBtn3 HoverA"><i class="fa fa-close"></i></a>
								</div>
								<!--export button-->
		...
		<div class="tab_pane" id="project_attachment">
			<div class="flex">
				<div class="form-width-1">
					<div class="file-uploader-frame" data-ajax-url="<?php echo url_to('erp.project.uploadprojectattachment') . '?id=' . $project_id . '&'; ?>">
				...
				<div class="form-width-1">
					<div class="table-responsive">
						<table class="table">
							<tbody class="attachment-holder" data-ajaxdel-url="<?php echo url_to('erp.project.projectdeleteattachment') . '?'; ?>">
								<?php
...
<div class="modal" id="phase_addedit_modal" role="dialog">
	<div class="modalbody">
		...
		<?php
		echo form_open(url_to('erp.project.phaseaddedit', $project_id), array(
...
<div class="modal" id="workgroup_add_modal" role="dialog">
	<div class="modalbody">
		...
		<?php
		 echo form_open(url_to('erp.project.phaseworkgroup', $project_id), array(
...
<div class="modal" id="rawmaterial_add_modal" role="dialog">
	<div class="modalbody">
		...
		<?php
		echo form_open(url_to('erp.project.rawmaterialadd', $project_id), array(
...
<div class="modal" id="rawmaterial_qty_modal" role="dialog">
	<div class="modalbody">
		...
		<?php
		echo form_open(url_to('erp.project.updateqty', $project_id), array(
