<div class="alldiv flex widget_title">
    ...
    <div class="title_right">
        <a href="<?php echo url_to('erp.goalsadd'); ?>" class="btn bg-success"><i class="fa fa-plus"></i> New Goals</a>
    </div>
</div>
<style>
    .prog-finished{
        height: 43px;
        width: 43px;
        border: 4px solid #3bbe39;
        border-radius: 50%;
        text-align: center;
        line-height: 5.428571vh;
        font-size: 8px;
        font-weight: 500;
    }
    .prog-not-finished{
...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?php echo url_to('erp.goals.data.table') . '?'; ?>">
        <div class="filterBox">
            <div class="flex">
                <h4>Filter and Search button</h4>
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?php echo url_to("erp.goals.export") . '?export=excel&'; ?>" href="<?php echo base_url() . 'erp/Goals/Goals-Export?export=excel&';?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?php echo url_to("erp.goals.export") . '?export=pdf&'; ?>" href="<?php echo base_url() . 'erp/Goals/Goals-Export?export=pdf&';?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?php echo url_to("erp.goals.export") . '?export=csv&'; ?>" href="<?php echo base_url() . 'erp/Goals/Goals-Export?export=csv&';?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
