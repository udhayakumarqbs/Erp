...
<div class="alldiv">
    <div class="datatable" data-ajax-url="<?= url_to('erp.timesheet.datatable') . '?'; ?>">
    <div class="filterBox">
            <div class="flex">
        ...
        <div class="tableHeader flex">
            ...
            <div class="formWidth textRight">
                ...
                <div class="export_container poF">
                    <ul class="exportUl">
                        <li><a data-default-href="<?= url_to('erp.timesheet.export').'?export=excel&'; ?>" href="<?= url_to('erp.timesheet.export').'?export=excel&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/xls.png'; ?>" alt="excel">EXCEL</a></li>
                        <li><a data-default-href="<?= url_to('erp.timesheet.export').'?export=pdf&'; ?>" href="<?= url_to('erp.timesheet.export').'?export=pdf&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/pdf.png'; ?>" alt="pdf">PDF</a></li>
                        <li><a data-default-href="<?= url_to('erp.timesheet.export').'?export=csv&'; ?>" href="<?= url_to('erp.timesheet.export').'?export=csv&'; ?>" target="_BLANK"><img src="<?php echo base_url() . 'assets/images/icons/csv.png'; ?>" alt="csv">CSV</a></li>
                    </ul>
...
<script>
    ...
    let config = JSON.parse('<?= $list_datatable_config; ?>');
