...
class EmailTemplatesController extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->data['templates'] = $this->_templates();
        $this->data['page'] = "email_templates/index";
    ...
    function form()
    {
        ...
        $template_language = $this->request->getPost('template_language') ?? "";
        ...
        // $view_data['model_info'] = $this->Email_templates_model->getAnEmailTemplate($template_name, $template_language);
        ...
        return view('erp/email_templates/form', $view_data);
    }
    ...
    function save_template()
    {
        ...
        if ($save_id) {
            ...
            $tab_view = view("erp/email_templates/tab_view", $view_data);
    ...
    function different_language_form($id = 0)
    {
        ...
        return view('erp/email_templates/different_language_form', $view_data);
    }
    ...
    function add_template_modal_form()
    {
        ...
        return view('erp/email_templates/add_template_modal_form', $view_data);
    }
}
