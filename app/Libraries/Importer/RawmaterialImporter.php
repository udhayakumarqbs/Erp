...
class RawmaterialImporter implements AbstractImporter
{
    private $type = AbstractImporter::CSV;
    private $table = "raw_materials";
    private $id_name = "raw_material_id";
    private $ci;
    protected $db;
    ...
    private function setup_warehouse_query()
    {
        ...
        $query = "INSERT INTO inventory_warehouse(warehouse_id,related_to,related_id) VALUES({f1},'raw_material',?) ";
    ...
    public function download_template()
    {
        ...
        header("Expires:0");
        header("Content-Disposition:attachment;filename=RawmaterialImport.csv");
