...
INSERT INTO `attachments` (attach_id, filename, related_to, related_id) VALUES (224, ERP.txt, rfq, 2);
...
INSERT INTO `customers` (cust_id, name, position, address, city, state, country, zip, email, phone, fax_num, office_num, company, gst, website, description, remarks, created_at, created_by) VALUES (38, admin2, test, test, test, test, test, test, test@2gmail.com, 9876543211, , , test company2, 1235, , , , 1645095130, 1);
INSERT INTO `customers` (cust_id, name, position, address, city, state, country, zip, email, phone, fax_num, office_num, company, gst, website, description, remarks, created_at, created_by) VALUES (45, john, web developer, chennai, Thiruvallur, tamilnadu, India, 602024, test@gmail.com, 1234567890, 1233554, 4654878554, qbsoftware company, 5754654466689898, , sdfghdf, gdfshsfd, 1704452307, 1);
INSERT INTO `customers` (cust_id, name, position, address, city, state, country, zip, email, phone, fax_num, office_num, company, gst, website, description, remarks, created_at, created_by) VALUES (46, jacob, Purchase Manager, chennai, Thiruvallur, tamilnadu, India, 602024, softriders@gmail.com, 23256789, 65454546, 8765446, softriders Global Pvvt Limited, 535468564, , sdvdf, dfgsd, 1704452363, 1);
INSERT INTO `customers` (cust_id, name, position, address, city, state, country, zip, email, phone, fax_num, office_num, company, gst, website, description, remarks, created_at, created_by) VALUES (47, geroge, web developer, chennai, Thiruvallur, tamilnadu, India, 602024, hrfksj@gmail.com, 8768797887, 896987687, 7984655868, Google, 87987897687, , drtytd, srthrdh, 1704452430, 1);
...
CREATE TABLE `erp_log` (
  ...
  `created_at` varchar(20) NOT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2928 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `erp_settings` (setting_id, s_name, s_value) VALUES (12, email_encryption, tls);
...
INSERT INTO `erp_settings` (setting_id, s_name, s_value) VALUES (16, smtp_password, Support4cus@Qbs);
...
INSERT INTO `erp_users` (user_id, name, last_name, email, phone, position, password, active, expired, is_admin, last_login, role_id, remember, description, created_at) VALUES (1, Qbs , Team, support@qbrainstorm.com, 9080780700, admin1, $2y$10$JcJTUdh3pp9H7h317ZzfpegXKpbQowDyHcWauUV7d0uQiLVZrnjWm, 1, 0, 1, 1657538814, 19, fcc923a6de504c37932e619e44128a4e3aedc51b, no descriptions, 1643791190);
INSERT INTO `erp_users` (user_id, name, last_name, email, phone, position, password, active, expired, is_admin, last_login, role_id, remember, description, created_at) VALUES (2, John, J, john@qbrainstorm.com, 1234567890, test, $2y$10$rZ1Uu51LjTwSb1tIGJ4l7eWEMi83eAg6hQrJI2TS.bnNVqaWLAN.i, 1, 0, 0, 1646822983, 22, , 0, 1643791190);
INSERT INTO `erp_users` (user_id, name, last_name, email, phone, position, password, active, expired, is_admin, last_login, role_id, remember, description, created_at) VALUES (3, Jacob, K, jacob@qbrainstorm.com, 9080780700, Purchase Manager, $2y$10$Sv15lDTaSUefO7JPYo4VQehQB6pD7lXTwZH3Q8SGPLeQVWFG4WyjW, 1, 0, 0, 1648889292, 11, 92bdd0f09edabdde89c2a3e5a5bdfc3b5e580245, 0, 1643791243);
...
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (5, joyal, 1);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (6, Kemar, 2);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (7, gear ad, 3);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (32, QBS Support, 28);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (33, Kumar, 29);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (34, na oru don Thamizharasi, 30);
INSERT INTO `lead_source` (source_id, source_name, marketing_id) VALUES (35, Production Thamiz, 31);
...
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (1, 2, 0, 2, TDWWS, test, Alvarpettai, Chennai, Tamil Nadu, India, 600087, 9564784521, Demo@test.com, www.demo.com, GB BABA , demo , , 1714196976, 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (5, 1, 2, 2, john, Purchase Manager, No.164, First Floor, Arcot Rd, Valasaravakkam, Chennai, Tamil Nadu, India, 600087, 09080780700, support@example.com, www.qbrainstorm.com, john enterprise, gh, , , 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (8, 3, 0, 3, admin, test, test, test, test, test, test, test, 9876543210, support@gmail.com, test, test, , , 0);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (9, 2, 4, 2, shankar, manager, test, chennai, tamilnadu, india, 6000125, 9876543210, shankar@qqq.com, , Shankar Company, , , , 0);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (10, 1, 3, 3, Saran, Sales, test, chennai, tamilnadu, india, 6000125, 9876543210, saran@qqq.com, , Shankar Company, test, , , 0);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (11, 1, 0, 3, Raj, Driver, test, chennai, tamilnadu, india, 6000125, 9876543210, raj@qqq.com, , Shankar Company, demo, , , 0);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (15, 1, 1, 3, kumar, 63680954, No Position, -, Dhrmapuri, TN, INDIA, 636809, 9874561230, 57665, 78, kumar@gmail.com, , 1703061296, 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (19, 3, 1, 2, Thamizharasi, web developer, chennai, Thiruvallur, tamilnadu, India, 602024, 01234567890, test@gmail.com, , qbs, sdgagdsfgs, gfdsheshsdh, 1705746799, 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (20, 4, 0, 3, sgh, gfsgff, 35, chennai, tamilnadu, india, 600087, 8556654, tamil@gmail.com, , qbs, cdbsdhsdh, , 1705747957, 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (21, 2, 1, 2, name, devl, test, chennai, TN, india, 636809, 1234567890, pasupthi@gamil.com, www.test.com, test, tesst, , 1705748139, 1);
INSERT INTO `leads` (lead_id, source_id, status, assigned_to, name, position, address, city, state, country, zip, phone, email, website, company, description, remarks, created_at, created_by) VALUES (22, 1, 0, 1, Q Brainstorm, test, test 1, Chennai, Tamil Nadu, India, 600087, 09080780700, support@qbrainstorm.com, test, ecommerce website development company in chennai, test, test, 1714368375, 1);
...
INSERT INTO `marketing` (marketing_id, name, related_to, related_id, amount, done_by, company, address, active, email, phone1, phone2, description, created_at, created_by) VALUES (3, gear ad, semi_finished, 1, 2000.00, joe, , test, 0, , +919876543210, , test, 1645792193, 1);
...
INSERT INTO `notification` (notify_id, title, notify_text, status, user_id, notify_email, notify_at, created_at, updated_at, created_by, related_to, related_id, related_base_url, job_id) VALUES (5, Product Inspection, Kindly Inspect the Product Before sending it., 0, 1, 0, 1711475820, 1711456047, 0, 1, quotation, 1, erp.sale.quotations.view, 144);
INSERT INTO `notification` (notify_id, title, notify_text, status, user_id, notify_email, notify_at, created_at, updated_at, created_by, related_to, related_id, related_base_url, job_id) VALUES (6, For Ashoke, Kindly see if Products are in good shape, 0, 1, 0, 1711480020, 1711460250, 0, 1, quotation, 1, erp.sale.quotations.view, 145);
...
INSERT INTO `quotations` (quote_id, code, subject, expiry_date, quote_date, cust_id, shippingaddr_id, billingaddr_id, currency_id, currency_place, transport_req, trans_charge, discount, terms_condition, payment_terms, status, created_at, created_by) VALUES (2, PRO-002, order, 2024-05-04, 2024-04-27, 45, 0, 0, 8, before, 1, 2700.00, 0.00, <p>mnmmm,mkmuummbki9lfdkguibnvbi</p>, demo, 0, 1714201029, 1);
...
INSERT INTO `rfq` (rfq_id, rfq_code, req_id, expiry_date, terms_condition, created_at, created_by, status) VALUES (2, RFQ1436, 6, 2024-01-26, dsagseg, 1705752467, 1, 0);
...
INSERT INTO `sale_order_items` (sale_item_id, related_to, related_id, price_id, quote_id, order_id, invoice_id, quantity, unit_price, amount, tax1, tax2, send_qty, return_qty, timestamp) VALUES (1, finished_good, 21, 1, 0, 0, 3, 2, 2000.00, 4000.00, 9, 18, 0, 0, 2024-02-06 16:44:05);
...
INSERT INTO `sale_order_items` (sale_item_id, related_to, related_id, price_id, quote_id, order_id, invoice_id, quantity, unit_price, amount, tax1, tax2, send_qty, return_qty, timestamp) VALUES (55, finished_good, 22, 2, 2, 0, 0, 1, 3000.00, 3000.00, 18, 9, 0, 0, 2024-04-27 12:27:09);
...
INSERT INTO `sale_payments` (sale_pay_id, invoice_id, payment_id, amount, paid_on, transaction_id, notes) VALUES (2, 2, 2, 1.00, 2024-02-23, IB12, fdsf);
