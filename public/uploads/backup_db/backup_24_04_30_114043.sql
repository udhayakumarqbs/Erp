...
INSERT INTO `erp_groups_map` (groupmap_id, group_id, related_id) VALUES (96, 17, 4);
...
CREATE TABLE `erp_log` (
  ...
  `created_at` varchar(20) NOT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2912 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
