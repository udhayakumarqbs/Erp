...
class TCPDF {
	...
	public function SVGImage($svgData, $x, $y, $w = '', $h = '', $type = '', $link = '', $align = '', $resize = false, $dpi = 300, $palign = '', $ismask = false, $imgmask = false, $border = 0, $fitonpage = false, $hidden = false, $alt = false) {
		// Output the SVG data as an image
		$this->ImageSVG('@' . $svgData, $x, $y, $w, $h, $type, $link, $align, $resize, $dpi, $palign, $ismask, $imgmask, $border, $fitonpage, $hidden, $alt);
	}
	...
	public function writeHTML($html, $ln=true, $fill=false, $reseth=false, $cell=false, $align='') {
		...
		if ($this->inxobj) {
			...
			if (isset($this->footerlen[$this->page])) {
				...
				if (isset($this->pagelen[$this->page])) {
					$this->footerpos[$this->page] = $this->pagelen[$this->page];
				} else {
					return 0;
				}
